...
const PWAInstallBanner = () => {
  ...
  if (!show) return null;
  if (sessionStorage.getItem("pwa-banner-hidden") === "1") return null;
  ...
  return (
    ...
    >
      <div style={{
        ...
        flexShrink: 0, boxShadow: "0 4px 16px rgba(16,185,129,0.4)",
      }}>
        <svg viewBox="0 0 24 24" fill="white" width="22" height="22">
          <path d="M12 2C8 2 5 5 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-4-3-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5S10.62 6.5 12 6.5s2.5 1.12 2.5 2.5S13.38 11.5 12 11.5z"/>
        </svg>
      </div>
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ color: "white", fontWeight: 700, fontSize: 14, lineHeight: 1.2 }}>
          Add ChekaMeds to your phone
        </div>
        <div style={{ color: "#94a3b8", fontSize: 12, marginTop: 2 }}>
          {isIOS
            ? "Tap Share → Add to Home Screen"
            : "Find medicine instantly — works like a native app"}
        </div>
      </div>
      {!isIOS && installPrompt && (
        <button
