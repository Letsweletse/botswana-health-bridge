        ...
        <div className="flex flex-col justify-center bg-[radial-gradient(circle_at_20%_0%,rgba(151,214,88,0.16),transparent_35%),#07130f] p-6 text-white sm:p-8 lg:p-12">
          ...
          <div className="mt-7 grid gap-3 sm:grid-cols-2">
            <div className="border border-emerald-300/20 bg-emerald-300/10 p-4">
              ...
              <p className="mt-3 font-bold text-white">From home</p>
              <p className="mt-1 text-sm leading-6 text-white/62">Submit symptoms and receive a secure video link where appropriate.</p>
            </div>
            <div className="border border-white/10 bg-white/[0.04] p-4">
              <ShieldCheck className="h-5 w-5 text-emerald-300" />
              <p className="mt-3 font-bold text-white">At a partner facility</p>
              <p className="mt-1 text-sm leading-6 text-white/62">A pharmacy or clinic helps with capture, setup, and medicine collection.</p>
            </div>
          </div>
          ...
          <p className="mt-6 border-l-4 border-amber-300 bg-amber-300/10 p-4 text-sm leading-6 text-white/68">
