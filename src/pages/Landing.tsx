  ...
  return (
    <div className="cm-page">
      <style>{`
        ...
        .services{padding:5.2rem 4.5rem;background:var(--light);border-top:1px solid var(--rule)}.services-header{margin-bottom:2.4rem}.services-header .section-title{opacity:1;transform:none;margin:0}.services-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:1.35rem}.s-card{display:flex;flex-direction:column;min-height:430px;background:#fff;border:1px solid var(--rule);border-radius:12px;overflow:hidden;box-shadow:0 10px 30px rgba(13,27,42,.05);opacity:0;transform:translateY(18px);transition:.55s}.s-card.visible{opacity:1;transform:translateY(0)}.s-card:hover{box-shadow:0 20px 50px rgba(13,27,42,.12);transform:translateY(-4px)}.s-img-wrap{height:190px;overflow:hidden;background:#e6f3ed}.s-img-photo{width:100%;height:100%;object-fit:cover;display:block;transition:transform .35s}.s-card:hover .s-img-photo{transform:scale(1.04)}.s-body{display:flex;flex-direction:column;flex:1;padding:1.25rem}.s-tag{font-size:.66rem;letter-spacing:1.7px;color:var(--accent);font-weight:800;margin-bottom:.65rem}.s-name{font-size:1.05rem;font-weight:800;color:var(--ink);margin-bottom:.45rem}.s-desc{font-size:.82rem;line-height:1.65;color:var(--soft);margin-bottom:1.2rem}.s-link{margin-top:auto;display:flex;align-items:center;justify-content:center;gap:.35rem;background:var(--accent);color:#fff;text-decoration:none;font-weight:800;font-size:.78rem;border-radius:6px;padding:.82rem}.s-link:hover{background:#14563a}.partners{padding:2rem 4.5rem;display:grid;grid-template-columns:auto 1fr;gap:2rem;align-items:center}.p-label{font-size:.75rem;color:var(--faint)}.p-row{display:grid;grid-template-columns:repeat(4,1fr);gap:1rem}.p-name{border:1px solid var(--rule);padding:1rem;text-align:center;color:var(--soft);font-family:'DM Serif Display',serif}.cm-footer{display:flex;justify-content:space-between;align-items:center;background:var(--ink);color:#fff;padding:2rem 4.5rem}.f-logo{font-family:'DM Serif Display',serif;font-size:1.25rem}.f-logo em{font-style:normal;color:var(--accent2)}.f-links{display:flex;gap:1.5rem;list-style:none;margin:0;padding:0}.f-links a{color:rgba(255,255,255,.45);text-decoration:none;font-size:.8rem}.f-copy{color:rgba(255,255,255,.28);font-size:.75rem}@keyframes fadeUp{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:translateY(0)}}@keyframes imgIn{from{opacity:0;transform:scale(1.03)}to{opacity:1;transform:scale(1)}}@keyframes slideOut{to{opacity:0;transform:translateY(-100%)}}@keyframes slideIn{from{opacity:0;transform:translateY(100%)}to{opacity:1;transform:translateY(0)}}@media(max-width:980px){.cm-nav{padding:0 1.25rem}.nav-links{display:none}.hero-text{position:relative;transform:none;padding:2rem 1.25rem;background:var(--ink);max-width:none}.hero-overlay{display:none}.hero-title{font-size:2.8rem}.hero-title em{min-width:150px}.hero-actions,.consult-actions{grid-template-columns:1fr;flex-direction:column}.hero-stats,.features-strip,.services,.partners,.cm-footer{padding-left:1.25rem;padding-right:1.25rem}.hero-stats,.features-strip,.services-grid,.p-row{grid-template-columns:1fr}.feat-item{border-right:0;border-bottom:1px solid var(--rule);padding:0 0 1rem}.consult{grid-template-columns:1fr}.consult-img-col{min-height:320px}.consult-content{padding:3rem 1.25rem}.partners,.cm-footer{display:block}.p-row{margin-top:1rem}.f-links{margin:1rem 0;flex-wrap:wrap}.s-card{min-height:auto}}
      `}</style>
      ...
      <section className="services" id="services">
        ...
        <div className="services-grid">
          {serviceCards.map((card) => (
            <div key={card.name} className="s-card">
              ...
              <div className="s-body">
                ...
                <Link className="s-link" to={card.to}>Learn more <ArrowSvg /></Link>
              </div>
            </div>
          ))}
        </div>
