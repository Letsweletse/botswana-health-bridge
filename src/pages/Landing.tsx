  ...
  return (
    <div className="cm-page">
      <style>{`
        ...
        .cm-page{--ink:#0d1b2a;--soft:#6b7c93;--faint:#a8b8c8;--accent:#1a6b4a;--accent2:#2d9768;--light:#f6f8fa;--rule:rgba(13,27,42,.08);font-family:'DM Sans',system-ui,sans-serif;background:#fff;color:var(--ink);overflow-x:hidden}.cm-page *{box-sizing:border-box}#progress{position:fixed;top:0;left:0;height:2px;background:var(--accent);z-index:999;width:0}.cm-nav{position:fixed;top:0;left:0;right:0;height:68px;z-index:50;display:flex;align-items:center;justify-content:space-between;padding:0 4rem;background:rgba(255,255,255,.96);backdrop-filter:blur(18px);border-bottom:1px solid var(--rule)}.logo{font-family:'DM Serif Display',serif;font-size:1.5rem;color:var(--ink);text-decoration:none}.logo em{font-style:normal;color:var(--accent)}.nav-links{display:flex;gap:2.2rem;list-style:none;margin:0;padding:0}.nav-links a{font-size:.84rem;color:var(--soft);text-decoration:none}.nav-links a:hover{color:var(--ink)}.nav-actions{display:flex;gap:.8rem}.btn-ghost,.btn-cta,.btn-primary,.btn-secondary,.btn-p,.btn-s{border-radius:4px;cursor:pointer;text-decoration:none;border:none;font-weight:600}.btn-ghost{padding:.55rem 1rem;color:var(--ink);background:transparent}.btn-cta{padding:.65rem 1.2rem;background:var(--ink);color:#fff}.btn-cta:hover,.btn-primary:hover,.btn-p:hover{background:var(--accent)}
        .hero{padding-top:68px}.hero-visual{position:relative;background:var(--ink);overflow:hidden}.hero-visual img{width:100%;display:block;animation:imgIn 1s ease forwards}.hero-overlay{position:absolute;inset:0;background:linear-gradient(105deg,rgba(13,27,42,.78),rgba(13,27,42,.52) 43%,rgba(13,27,42,.08) 72%,transparent)}.hero-text{position:absolute;top:50%;left:0;transform:translateY(-50%);z-index:2;max-width:720px;padding:0 4.5rem;color:#fff}.eyebrow{display:flex;align-items:center;gap:.7rem;margin-bottom:1.4rem;color:var(--accent2);font-size:.72rem;letter-spacing:2px;text-transform:uppercase;font-weight:700;animation:fadeUp .7s .3s both}.eyebrow-line{width:28px;height:1px;background:var(--accent2)}.hero-title{font-family:'DM Serif Display',serif;font-size:4.35rem;line-height:1.05;margin:0 0 1.4rem;animation:fadeUp .75s .45s both}.hero-title em{font-style:italic;color:var(--accent2);display:inline-block;min-width:210px}.word-rotate-wrap{display:inline-block;overflow:hidden;vertical-align:bottom}.word-rotate.slide-out{animation:slideOut .32s ease both}.word-rotate.slide-in{animation:slideIn .4s ease both}.hero-body{max-width:500px;font-size:1.06rem;line-height:1.8;color:rgba(255,255,255,.78);font-weight:300;margin-bottom:2rem;animation:fadeUp .8s .58s both}.hero-actions{display:flex;gap:.9rem;animation:fadeUp .8s .72s both}.btn-primary{padding:.9rem 1.9rem;background:var(--accent);color:#fff;box-shadow:0 12px 30px rgba(26,107,74,.25)}.btn-secondary{padding:.9rem 1.6rem;background:rgba(255,255,255,.12);color:#fff;border:1px solid rgba(255,255,255,.25)}.hero-stats{display:grid;grid-template-columns:repeat(4,1fr);background:var(--ink);padding:1.8rem 4.5rem;color:#fff}.stat-item{border-right:1px solid rgba(255,255,255,.08);padding:0 2rem}.stat-item:first-child{padding-left:0}.stat-item:last-child{border-right:0}.stat-num{font-family:'DM Serif Display',serif;font-size:2rem}.stat-num sup{font-family:'DM Sans';font-size:1rem;color:var(--accent2)}.stat-label{font-size:.74rem;color:rgba(255,255,255,.42)}
        .features-strip{display:grid;grid-template-columns:repeat(4,1fr);gap:0;padding:2.3rem 4.5rem;border-bottom:1px solid var(--rule)}.feat-item{display:flex;gap:1rem;padding-right:2rem;border-right:1px solid var(--rule);opacity:0;transform:translateY(14px);transition:.6s}.feat-item.visible{opacity:1;transform:translateY(0)}.feat-item:last-child{border-right:0}.feat-icon{width:40px;height:40px;display:flex;align-items:center;justify-content:center;border-radius:8px;background:#e6f3ed;color:var(--accent);font-weight:800}.feat-title{font-size:.88rem;font-weight:800}.feat-desc{margin-top:.25rem;font-size:.78rem;color:var(--soft);line-height:1.55}
        .consult{display:grid;grid-template-columns:1fr 1fr;border-top:1px solid var(--rule)}.consult-img-col{position:relative;min-height:540px;overflow:hidden;background:#f2f5f3}.consult-img-col img{width:100%;height:100%;object-fit:cover;display:block}.consult-img-gradient{position:absolute;inset:0;background:linear-gradient(to right,transparent 62%,#fff)}.consult-content{display:flex;flex-direction:column;justify-content:center;padding:5rem}.section-kicker{font-size:.72rem;text-transform:uppercase;letter-spacing:2px;color:var(--accent);font-weight:800;opacity:0;transform:translateY(14px);transition:.55s}.section-kicker.visible{opacity:1;transform:translateY(0)}.section-title{font-family:'DM Serif Display',serif;font-size:3.05rem;line-height:1.08;margin:.9rem 0 1.2rem;opacity:0;transform:translateY(16px);transition:.65s}.section-title.visible{opacity:1;transform:translateY(0)}.section-title em{font-style:italic;color:var(--accent)}.section-body{max-width:460px;line-height:1.85;color:var(--soft);opacity:0;transform:translateY(16px);transition:.7s}.section-body.visible{opacity:1;transform:translateY(0)}.consult-actions{display:grid;grid-template-columns:1fr 1fr;gap:.9rem;margin-top:2rem;opacity:0;transform:translateY(14px);transition:.6s}.consult-actions.visible{opacity:1;transform:translateY(0)}.btn-p,.btn-s{display:flex;justify-content:center;align-items:center;padding:.9rem 1rem}.btn-p{background:var(--accent);color:#fff}.btn-s{border:1px solid var(--rule);color:var(--ink);background:#fff}.secure-row{margin-top:1.2rem;color:var(--faint);font-size:.76rem}
        .services{padding:5.2rem 4.5rem;background:radial-gradient(circle at 15% 0%,rgba(45,151,104,.14),transparent 34%),radial-gradient(circle at 85% 15%,rgba(26,107,74,.10),transparent 30%),var(--light);border-top:1px solid var(--rule)}.services-header{margin-bottom:2.4rem}.services-header .section-title{opacity:1;transform:none;margin:0}.services-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:1.35rem}.s-card{position:relative;display:flex;flex-direction:column;min-height:420px;background:rgba(255,255,255,.92);border:1px solid rgba(26,107,74,.14);border-radius:18px;overflow:hidden;box-shadow:0 14px 45px rgba(13,27,42,.08),0 0 0 1px rgba(255,255,255,.65) inset;opacity:0;transform:translateY(18px);transition:opacity .55s,transform .55s,box-shadow .35s,border-color .35s}.s-card::before{content:'';position:absolute;inset:-2px;border-radius:20px;background:linear-gradient(135deg,rgba(45,151,104,.7),rgba(255,255,255,0),rgba(26,107,74,.45));opacity:.34;z-index:0;pointer-events:none}.s-card::after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,rgba(255,255,255,0),rgba(45,151,104,.08));z-index:0;pointer-events:none}.s-card.visible{opacity:1;transform:translateY(0)}.s-card:hover{border-color:rgba(45,151,104,.55);box-shadow:0 28px 70px rgba(13,27,42,.15),0 0 34px rgba(45,151,104,.25);transform:translateY(-7px)}.s-img-wrap,.s-body{position:relative;z-index:1}.s-img-wrap{height:190px;overflow:hidden;background:#e6f3ed}.s-img-photo{width:100%;height:100%;object-fit:cover;display:block;transition:transform .45s,filter .45s}.s-card:hover .s-img-photo{transform:scale(1.06);filter:saturate(1.08) contrast(1.03)}.s-body{display:flex;flex-direction:column;flex:1;padding:1.25rem}.s-tag{font-size:.66rem;letter-spacing:1.7px;color:var(--accent);font-weight:900;margin-bottom:.65rem}.s-name{font-size:1.08rem;font-weight:900;color:var(--ink);margin-bottom:.45rem}.s-desc{font-size:.83rem;line-height:1.68;color:var(--soft);margin-bottom:0}.s-card-action{margin-top:auto;padding-top:1rem;color:var(--accent);font-size:.76rem;font-weight:900;letter-spacing:.8px;text-transform:uppercase;display:flex;align-items:center;gap:.4rem}.s-card-action span{transition:transform .2s}.s-card:hover .s-card-action span{transform:translateX(4px)}.partners{padding:2rem 0;display:grid;grid-template-columns:auto 1fr;gap:2rem;align-items:center;overflow:hidden;background:#fff;border-top:1px solid var(--rule)}.p-label{font-size:.75rem;color:var(--faint);padding-left:4.5rem;white-space:nowrap}.p-carousel{position:relative;overflow:hidden}.p-carousel::before,.p-carousel::after{content:'';position:absolute;top:0;bottom:0;width:60px;z-index:2;pointer-events:none}.p-carousel::before{left:0;background:linear-gradient(to right,#fff,transparent)}.p-carousel::after{right:0;background:linear-gradient(to left,#fff,transparent)}.p-track{display:flex;width:max-content;gap:1rem;animation:partnerSlide 18s linear infinite}.p-carousel:hover .p-track{animation-play-state:paused}.p-name{min-width:190px;border:1px solid rgba(26,107,74,.14);padding:1rem 1.25rem;text-align:center;color:var(--accent);background:linear-gradient(180deg,#fff,#f5fbf8);border-radius:999px;font-family:'DM Serif Display',serif;box-shadow:0 10px 28px rgba(13,27,42,.06)}.cm-footer{display:flex;justify-content:space-between;align-items:center;background:var(--ink);color:#fff;padding:2rem 4.5rem}.f-logo{font-family:'DM Serif Display',serif;font-size:1.25rem}.f-logo em{font-style:normal;color:var(--accent2)}.f-links{display:flex;gap:1.5rem;list-style:none;margin:0;padding:0}.f-links a{color:rgba(255,255,255,.45);text-decoration:none;font-size:.8rem}.f-copy{color:rgba(255,255,255,.28);font-size:.75rem}@keyframes fadeUp{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:translateY(0)}}@keyframes imgIn{from{opacity:0;transform:scale(1.03)}to{opacity:1;transform:scale(1)}}@keyframes slideOut{to{opacity:0;transform:translateY(-100%)}}@keyframes slideIn{from{opacity:0;transform:translateY(100%)}to{opacity:1;transform:translateY(0)}}@keyframes partnerSlide{from{transform:translateX(0)}to{transform:translateX(-50%)}}@media(max-width:980px){.cm-nav{padding:0 1.25rem}.nav-links{display:none}.hero-text{position:relative;transform:none;padding:2rem 1.25rem;background:var(--ink);max-width:none}.hero-overlay{display:none}.hero-title{font-size:2.8rem}.hero-title em{min-width:150px}.hero-actions,.consult-actions{grid-template-columns:1fr;flex-direction:column}.hero-stats,.features-strip,.services,.cm-footer{padding-left:1.25rem;padding-right:1.25rem}.hero-stats,.features-strip,.services-grid{grid-template-columns:1fr}.feat-item{border-right:0;border-bottom:1px solid var(--rule);padding:0 0 1rem}.consult{grid-template-columns:1fr}.consult-img-col{min-height:320px}.consult-content{padding:3rem 1.25rem}.partners{display:block;padding:1.5rem 0}.p-label{padding:0 1.25rem 1rem}.f-links{margin:1rem 0;flex-wrap:wrap}.cm-footer{display:block}.s-card{min-height:auto}}
      `}</style>
        ...
        <div className="p-carousel">
          <div className="p-track">
            {partners.map((partner, index) => (
              <div key={`${partner}-${index}`} className="p-name">{partner}</div>
            ))}
          </div>
        </div>
      </div>
