  ...
  try {
    ...
    const adminHtml = `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:24px;background:#ffffff;color:#0f172a">
        ...
        <p style="font-size:14px;line-height:1.6">A new health facility has just registered on ChekaMeds and is awaiting admin approval before it can access the dashboard.</p>
        ...
        <p style="font-size:13px;color:#64748b;line-height:1.6">Approve or reject this facility from the ChekaMeds admin panel to grant dashboard access.</p>
    ...
    const facilityHtml = `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:24px;background:#ffffff;color:#0f172a">
        <div style="border-bottom:2px solid #10b981;padding-bottom:16px;margin-bottom:24px">
          <h1 style="margin:0;font-size:22px;color:#0f172a">Your ChekaMeds facility registration was received</h1>
          <p style="margin:6px 0 0;color:#64748b;font-size:13px">National Medicine Stock Dashboard · Botswana</p>
        </div>
        <p style="font-size:14px;line-height:1.6">Dumela ${safeFullName},</p>
        <p style="font-size:14px;line-height:1.6">Your facility <strong>${safeClinicName}</strong> has been registered and is awaiting admin approval. You'll be able to sign in and upload medicine inventory once it's approved.</p>
        <div style="margin:22px 0;padding:16px;background:#fffbeb;border:1px solid #fde68a;color:#92400e;font-size:14px;line-height:1.6">
